...
export const latestStories: IStory[] = [
  {
    thumbnail: "1.png",
    title: "Gemma",
    description:
...
export const comedyStories: IStory[] = [
  {
    thumbnail: "1.png",
